...
// ============================================
const SCRIPT_VERSION = "v2.11.0";
console.log(`🚀 [极核面板] 脚本版本: ${SCRIPT_VERSION} (2026-09-10 v2.11.0 ①粘贴清洗增强：添加账号粘贴 Token/Bark 自动去除 Bearer 前缀、空格换行、引号、Key 标签与尾部斜杠；②社区任务开关保存已核验正常；③账号执行异常不再拖垮后续账号（隔离运行）。沿用v2.10.0)`);
